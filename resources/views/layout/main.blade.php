...
<html lang="en">
  ...
  <body class="nav-md">
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-stethoscope"></i> <span>BPJS-ASN</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                  ...
                  <li><a href="{{ route('index') }}"><i class="fa fa-bar-chart-o"></i> Pengajuan</a>
                    
                  </li>
                  
                  <li><a><i class="fa fa-pencil"></i> Ubah Password</a>
   ...
   <script src="{{ asset('lte/vendors/bootstrap/dist/js/bootstrap.bundle.min.js ')}}"></script>
    ...
    <!-- jQuery Sparklines -->
    <script src="{{ asset('lte/vendors/jquery-sparkline/dist/jquery.sparkline.min.js ')}}"></script>
    <!-- Flot -->
